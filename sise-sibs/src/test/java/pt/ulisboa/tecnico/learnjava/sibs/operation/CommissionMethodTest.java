...
public class CommissionMethodTest {
	...
	public void transferOperation1000() throws OperationException {
		Operation operation = new TransferOperation(SOURCE_IBAN, TARGET_IBAN, 1000, service);
	...
	public void transferOperation15() throws OperationException {
		Operation operation = new TransferOperation(SOURCE_IBAN, TARGET_IBAN, 15, service);
	...
	public void transferOperation1() throws OperationException {
		Operation operation = new TransferOperation(SOURCE_IBAN, TARGET_IBAN, 1, service);
