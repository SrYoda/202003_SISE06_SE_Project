...
//
//public class TransferMethodTest_ProjectPart1_6 {
//
...
//		this.sibs = new Sibs(NOPS, this.mockServices);
//	}
//
...
//
//	@Test
//	public void successfullNoComission() throws BankException, AccountException, SibsException, OperationException,
...
//
//	@Test
//	public void successfullWithComission() throws BankException, AccountException, SibsException, OperationException,
//			ClientException, ServicesException {
//
//		when(this.mockServices.AccountExists(IBAN_1)).thenReturn(true);
//		when(this.mockServices.AccountExists(IBAN_2)).thenReturn(true);
...
//
//	@Test
//	public void operationFailTest() throws BankException, AccountException, SibsException, OperationException,
//			ClientException, ServicesException {
//
//		when(this.mockServices.AccountExists(IBAN_1)).thenReturn(true);
//		when(this.mockServices.AccountExists(IBAN_2)).thenReturn(true);
